...
void CClientNode::_QueryRoleList( const void *pData, size_t dataLength )
{
	...
	memcpy(pListData->szAccountName,szAccountName,nLen - 1);
	pListData->szAccountName[nLen - 1] = '\0';
...
void CClientNode::_LockOrUnlockRole( const void *pData, size_t dataLength )	//???????
{
