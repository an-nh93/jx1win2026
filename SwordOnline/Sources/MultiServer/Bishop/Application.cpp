...
/*	case WM_TIMER:
	...
	case WM_COMMAND:
		...
		case IDOK:
			...
			//Code them chuc nang cu~ nam thang ngay
			time_t rawtime;
			struct tm * timeinfo;
			...
			//Limit version ben KProtocolDef.h, KPROTOCOL_EXPIRATION_DATE   20311220
			...
			else
			{
				...
				//g_nBackupTimer = ::SetTimer( hwnd, g_nBackupEvent, 60000, NULL ); //TamLTM fix kill it;
...
//	g_BackupSpaceTime = theConfigFile.ReadInteger( "Setting", "BackupSpaceTime", 0 );*/ //TamLTM fix kill it;
