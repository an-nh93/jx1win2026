...
void *CBuffer::operator new( size_t objectSize, buffer_placement_t /* bp */ )
{
	/*
...
void CBuffer::operator delete( void *pObject )
{
	SAFE_DELETE_ARRAY( pObject );
}

void CBuffer::operator delete( void *pObject, buffer_placement_t /* bp */ )
{
	SAFE_DELETE_ARRAY( pObject );
}
...
CBuffer *CBuffer::Allocator::Allocate()
{
	...
	{
		pBuffer = new( buffer_placement_t( m_bufferSize ) )CBuffer( *this, m_bufferSize );
