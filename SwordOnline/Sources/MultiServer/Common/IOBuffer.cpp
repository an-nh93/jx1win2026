...
void *CIOBuffer::operator new( size_t objectSize, buffer_placement_t /* bp */ )
{
	/*
...
void CIOBuffer::operator delete( void *pObject, buffer_placement_t /* bp */ )
{
	SAFE_DELETE_ARRAY( pObject );
}
...
CIOBuffer *CIOBuffer::Allocator::Allocate()
{
	...
	{
		pBuffer = new( buffer_placement_t( m_bufferSize ) )CIOBuffer( *this, m_bufferSize );
