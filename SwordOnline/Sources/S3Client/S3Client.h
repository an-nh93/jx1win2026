...
struct KClientCallback : public IClientCallback {
    ...
    void ChannelMessageArrival(DWORD nChannelID, char *szSendName, const char *pMsgBuff, unsigned short nMsgLength,
                               const char *pItem = 0, BYTE btSomeFlag = 0, bool bSucc = false);

    void MSNMessageArrival(char *szSourceName, char *szSendName, const char *pMsgBuff, unsigned short nMsgLength,
                           const char *pItem = 0, bool bSucc = false);
