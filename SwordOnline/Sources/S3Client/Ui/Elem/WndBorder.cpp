...
void
_DrawBorder(KRUPoint *zdata, int zsizeline, int &zpos, unsigned char &zdir, int x, int y, int xe, int ye, int nNature) {
    int i, temp, temp1;
...
void
DrawBorder(unsigned char &zframe, unsigned char &uctimedelay, int &zpos, unsigned char &zdir, unsigned char &ztimedelay,
           int x, int y, int width, int height, int nNature) {
    if (nNature <= 0)
        return;
