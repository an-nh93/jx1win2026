...
*功能：设置鼠标提示窗口的基本信息
************************************************************************/
void KSpaceOver::SetSpaceOverInfo(void *pWnd, int nObj, int x, int y, unsigned int uHoverTime, bool LAlign,
                                  bool bFollowCursor) {
