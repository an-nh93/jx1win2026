...
public:
    ...
    void SetSpaceOverInfo(void *pWnd, int nObj, int x, int y, unsigned int uHoverTime, bool LAlign = false,
...
void SetSpaceOverObjectDesc(void *pWnd, int nObj, unsigned int uGenre,
                            unsigned int uId, int nContainer, int x, int y, unsigned int uHoverTime,
                            bool LAlign = false);
//绘制被拖动游戏对象的函数
