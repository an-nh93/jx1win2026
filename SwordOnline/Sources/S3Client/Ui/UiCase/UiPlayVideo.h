...
typedef u8 (*KLVideoSoundFn)(void PTR4

* dd);

typedef HKLVIDEO (*KLVideoOpenFn)(const char PTR4
...
typedef void (*KLVideoToBufferFn)(HKLVIDEO bnk, void PTR4
...
typedef void (*KLVideoSndtrackFn)(u32
track);
