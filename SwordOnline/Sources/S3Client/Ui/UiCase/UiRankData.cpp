...
void KUiRankData::LoadScheme(const char *pScheme) {
    ...
    if (Ini.Load(Buff)) {
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenPlayFaction[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                       (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenPlayNameTxt[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                       (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenGradeVal[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                    (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenKillNpcVal[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                      (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenPkPlayerVal[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                       (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenMaxKillVal[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                      (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenGetItemVal[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                      (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenGetFlagVal[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                      (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
        ...
        for (i = 0; i < MISSION_STATNUM; i++) {
            ...
            m_TopTenDeathVal[i].SetPosition(nValue, m_nTopTenPos + (m_nTitleFont + m_nLeft_Right * 2) +
                                                    (m_nTitleFont + m_nLeft_Right * 2) * i);
        }
    }
}
...
void KUiRankData::Breathe() {
    ...
    for (int i = 0; i < MISSION_STATNUM; i++) {
        ...
        g_pCoreShell->GetGameData(GDI_MISSION_RANKDATA,
                                  (unsigned int) (&tmp), i);
        tmp.nParam[MISSION_PARAM_AVAILABLE] ? m_TopTenPlayFaction[i].SetText(m_szFaction[tmp.ucGroup])
        ...
        tmp.nParam[MISSION_PARAM_AVAILABLE] ? m_TopTenGradeVal[i].SetIntText(tmp.nParam[2])
                                            : m_TopTenGradeVal[i].Clear();
        tmp.nParam[MISSION_PARAM_AVAILABLE] ? m_TopTenDeathVal[i].SetIntText(tmp.nParam[3])
                                            : m_TopTenDeathVal[i].Clear();
        tmp.nParam[MISSION_PARAM_AVAILABLE] ? m_TopTenMaxKillVal[i].SetIntText(tmp.nParam[4])
                                            : m_TopTenMaxKillVal[i].Clear();
        tmp.nParam[MISSION_PARAM_AVAILABLE] ? m_TopTenPkPlayerVal[i].SetIntText(tmp.nParam[5])
                                            : m_TopTenPkPlayerVal[i].Clear();
        tmp.nParam[MISSION_PARAM_AVAILABLE] ? m_TopTenKillNpcVal[i].SetIntText(tmp.nParam[7])
                                            : m_TopTenKillNpcVal[i].Clear();
        tmp.nParam[MISSION_PARAM_AVAILABLE] ? m_TopTenGetItemVal[i].SetIntText(tmp.nParam[11])
                                            : m_TopTenGetItemVal[i].Clear();
        tmp.nParam[MISSION_PARAM_AVAILABLE] ? m_TopTenGetFlagVal[i].SetIntText(tmp.nParam[13])
