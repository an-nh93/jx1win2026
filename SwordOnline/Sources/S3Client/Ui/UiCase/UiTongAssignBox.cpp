...
void KUiTongAssignBox::LoadScheme(const char *pScheme) {
    if (ms_pSelf) {
        ...
        if (Ini.Load(Buff)) {
            ...
            Ini.GetString("Main", "DirectorString", "", ms_pSelf->m_szDirectorString,
                          sizeof(ms_pSelf->m_szDirectorString));
            Ini.GetString("Main", "ManagerString", "", ms_pSelf->m_szManagerString,
                          sizeof(ms_pSelf->m_szManagerString));
            ...
            Ini.GetString("ErrorBox", "WithoutFaction", "", ms_pSelf->m_szWithoutFaction,
                          sizeof(ms_pSelf->m_szWithoutFaction));
...
**********************************************************************/
void
KUiTongAssignBox::ArrangeData(int nType, char *szTarName, char *szTarAgName, int nCurrentFigure, int nCurrentPosition) {
