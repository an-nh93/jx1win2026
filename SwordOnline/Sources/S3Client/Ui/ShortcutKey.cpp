            ...
            PATTERNMAP() {
                const struct _PATTERN {
                    ...
                    DWORD value;
                        ...
                        //modifier
                        {"Shift",       HOTKEYF_SHIFT << 16,   HOTKEYF_SHIFT << 16},
                        {"Control",     HOTKEYF_CONTROL << 16, HOTKEYF_CONTROL << 16},
                        {"Alt",         HOTKEYF_ALT << 16,     HOTKEYF_ALT << 16},
                        {"Ext",         HOTKEYF_EXT << 16,     HOTKEYF_EXT << 16},

                        //vk
                        {"LButton",     MASK_VKEY,             VK_LBUTTON},
                        {"RButton",     MASK_VKEY,             VK_RBUTTON},
                        {"Cancel",      MASK_VKEY,             VK_CANCEL},
                        {"MButton",     MASK_VKEY,             VK_MBUTTON},
                        {"BackSpace",   MASK_VKEY,             VK_BACK},
                        {"Tab",         MASK_VKEY,             VK_TAB},
                        {"Clear",       MASK_VKEY,             VK_CLEAR},
                        {"Return",      MASK_VKEY,             VK_RETURN},
                        {"Pause",       MASK_VKEY,             VK_PAUSE},
                        {"Convert",     MASK_VKEY,             VK_CONVERT},
                        {"NonConvert",  MASK_VKEY,             VK_NONCONVERT},
                        {"Accept",      MASK_VKEY,             VK_ACCEPT},
                        {"ModeChange",  MASK_VKEY,             VK_MODECHANGE},
                        {"Escape",      MASK_VKEY,             VK_ESCAPE},
                        {"Space",       MASK_VKEY,             VK_SPACE},
                        {"Prior",       MASK_VKEY,             VK_PRIOR},
                        {"Next",        MASK_VKEY,             VK_NEXT},
                        {"End",         MASK_VKEY,             VK_END},
                        {"Home",        MASK_VKEY,             VK_HOME},
                        {"Left",        MASK_VKEY,             VK_LEFT},
                        {"Up",          MASK_VKEY,             VK_UP},
                        {"Right",       MASK_VKEY,             VK_RIGHT},
                        {"Down",        MASK_VKEY,             VK_DOWN},
                        {"Insert",      MASK_VKEY,             VK_INSERT},
                        {"Delete",      MASK_VKEY,             VK_DELETE},
                        {"Select",      MASK_VKEY,             VK_SELECT},
                        {"Print",       MASK_VKEY,             VK_PRINT},
                        {"Execute",     MASK_VKEY,             VK_EXECUTE},
                        {"SnapShot",    MASK_VKEY,             VK_SNAPSHOT},
                        {"Help",        MASK_VKEY,             VK_HELP},
                        {"0",           MASK_VKEY,             '0'},
                        {"1",           MASK_VKEY,             '1'},
                        {"2",           MASK_VKEY,             '2'},
                        {"3",           MASK_VKEY,             '3'},
                        ...
                        {"Y",           MASK_VKEY,             'Y'},
                        {"Z",           MASK_VKEY,             'Z'},
                        {"Num0",        MASK_VKEY,             VK_NUMPAD0},
                        {"Num1",        MASK_VKEY,             VK_NUMPAD1},
                        {"Num2",        MASK_VKEY,             VK_NUMPAD2},
                        {"Num3",        MASK_VKEY,             VK_NUMPAD3},
                        {"Num4",        MASK_VKEY,             VK_NUMPAD4},
                        {"Num5",        MASK_VKEY,             VK_NUMPAD5},
                        {"Num6",        MASK_VKEY,             VK_NUMPAD6},
                        {"Num7",        MASK_VKEY,             VK_NUMPAD7},
                        {"Num8",        MASK_VKEY,             VK_NUMPAD8},
                        {"Num9",        MASK_VKEY,             VK_NUMPAD9},
                        {"Num+",        MASK_VKEY,             VK_ADD},
                        {"Num-",        MASK_VKEY,             VK_SUBTRACT},
                        {"Num*",        MASK_VKEY,             VK_MULTIPLY},
                        {"Num/",        MASK_VKEY,             VK_DIVIDE},
                        {"Separator",   MASK_VKEY,             VK_SEPARATOR},
                        {"Num.",        MASK_VKEY,             VK_DECIMAL},
                        {"F1",          MASK_VKEY,             VK_F1},
                        {"F2",          MASK_VKEY,             VK_F2},
                        {"F3",          MASK_VKEY,             VK_F3},
                        {"F4",          MASK_VKEY,             VK_F4},
                        ...
                        {"F8",          MASK_VKEY,             VK_F8},
                        {"F9",          MASK_VKEY,             VK_F9},
                        {"F10",         MASK_VKEY,             VK_F10},
                        {"F11",         MASK_VKEY,             VK_F11},
                        {"F12",         MASK_VKEY,             VK_F12},
                        {"F13",         MASK_VKEY,             VK_F13},
                        {"F14",         MASK_VKEY,             VK_F14},
                        {"F15",         MASK_VKEY,             VK_F15},
                        {"F16",         MASK_VKEY,             VK_F16},
                        {"F17",         MASK_VKEY,             VK_F17},
                        {"F18",         MASK_VKEY,             VK_F18},
                        {"F19",         MASK_VKEY,             VK_F19},
                        {"F20",         MASK_VKEY,             VK_F20},
                        {"F21",         MASK_VKEY,             VK_F21},
                        {"F22",         MASK_VKEY,             VK_F22},
                        {"F23",         MASK_VKEY,             VK_F23},
                        {"F24",         MASK_VKEY,             VK_F24},
                        {"CapLock",     MASK_VKEY,             VK_CAPITAL},
                        {"NumLock",     MASK_VKEY,             VK_NUMLOCK},
                        {"ScrollLock",  MASK_VKEY,             VK_SCROLL},
                        {";",           MASK_VKEY,             0x00BA},
                        {"=",           MASK_VKEY,             0x00BB},
                        {",",           MASK_VKEY,             0x00BC},
                        {"-",           MASK_VKEY,             0x00BD},
                        ...
                        //modifier alias
                        {"Ctrl",        HOTKEYF_CONTROL << 16, HOTKEYF_CONTROL << 16},
                        {"Menu",        HOTKEYF_ALT << 16,     HOTKEYF_ALT << 16},
                        {"Break",       MASK_VKEY,             VK_PAUSE},

                        //vk alias
                        {"ESC",         MASK_VKEY,             VK_ESCAPE},
                        {"Enter",       MASK_VKEY,             VK_RETURN},
                        {"BACK",        MASK_VKEY,             VK_BACK},
                        {"INS",         MASK_VKEY,             VK_INSERT},
                        {"DEL",         MASK_VKEY,             VK_DELETE},
                        {"PageUp",      MASK_VKEY,             VK_PRIOR},
                        {"PageDown",    MASK_VKEY,             VK_NEXT},
                        {"ScrlLock",    MASK_VKEY,             VK_SCROLL},
                        {"NumAdd",      MASK_VKEY,             VK_ADD},
                        {"NumSub",      MASK_VKEY,             VK_SUBTRACT},
                        {"NumMul",      MASK_VKEY,             VK_MULTIPLY},
                        {"NumDiv",      MASK_VKEY,             VK_DIVIDE},
                        {"NumDecimal",  MASK_VKEY,             VK_DECIMAL},
                        {"PrintScreen", MASK_VKEY,             VK_SNAPSHOT},

                        {"LDButton",    MASK_VKEY, VK_LDBUTTON},
                        {"RDButton",    MASK_VKEY, VK_RDBUTTON},
                        {"MDButton",    MASK_VKEY, VK_MDBUTTON},
                };
...
int LuaSayPhrase(Lua_State *L) {
    ...
    if (nLen > 0) {
        ...
        if (nChannelID != -1) {
            if (KUiPlayerBar::IsCanSendMessage(szPhrase, nLen, KUiMsgCentrePad::GetChannelTitle(
                    KUiMsgCentrePad::GetChannelIndex(nChannelID)), nChannelID)) {
                char Buffer[1536];
                nLen = KUiFaceSelector::ConvertFaceText(Buffer, szPhrase, nLen);
                nLen = TEncodeText(Buffer, nLen);
                KUiMsgCentrePad::CheckChannel(KUiMsgCentrePad::GetChannelIndex(nChannelID), true);
                KUiPlayerBar::OnSendChannelMessage(nChannelID, Buffer, nLen);
            }
        }
    }
...
int Mouse_Action(Lua_State *L) {
    ...
    KUiPlayerItem SelectPlayer;
    int nNPCKind = -1;
    if (g_pCoreShell->FindSelectNPC(KShortcutKeyCentre::ms_MouseX, KShortcutKeyCentre::ms_MouseY, relation_all, false,
                                    &SelectPlayer, nNPCKind)) {
        ...
        if (nRelation == relation_enemy) {
            ...
            if (!g_pCoreShell->LockSomeoneUseSkill(SelectPlayer.nIndex,
                                                   immedItemSkillInfo.IMmediaSkill[0].uId))    //锁定失败
    ...
    int nObjKind = -1;
    int nObjectIdx = 0;
    if (g_pCoreShell->FindSelectObject(KShortcutKeyCentre::ms_MouseX, KShortcutKeyCentre::ms_MouseY, false, nObjectIdx,
                                       nObjKind)) {
...
int Mouse_Force0(Lua_State *L) {
    ...
    g_pCoreShell->UseSkill(KShortcutKeyCentre::ms_MouseX, KShortcutKeyCentre::ms_MouseY,
                           immedItemSkillInfo.IMmediaSkill[0].uId);
...
int Mouse_Force1(Lua_State *L) {
    ...
    g_pCoreShell->UseSkill(KShortcutKeyCentre::ms_MouseX, KShortcutKeyCentre::ms_MouseY,
                           immedItemSkillInfo.IMmediaSkill[1].uId);
...
int Mouse_Menu(Lua_State *L) {
    ...
    KUiPlayerItem SelectPlayer;
    int nKind = -1;
    if (!(g_pCoreShell->FindSelectNPC(KShortcutKeyCentre::ms_MouseX, KShortcutKeyCentre::ms_MouseY,
                                      relation_none | relation_ally | relation_enemy, false, &SelectPlayer, nKind, true)
          && kind_player == nKind))
        return 0;
...
int Mouse_Emote_Menu(Lua_State *L) {
    ...
    int nKind = -1;
    if (!(g_pCoreShell->FindSelectNPC(KShortcutKeyCentre::ms_MouseX, KShortcutKeyCentre::ms_MouseY,
                                      relation_none | relation_ally | relation_enemy, false, &SelectPlayer, nKind)
          && kind_player == nKind))
        return 0;
            ...
            if (SelectPlayer.uId != 0) {
                if (g_pCoreShell) {
                    if (g_pCoreShell && SelectPlayer.nIndex != -1)
                        g_pCoreShell->OperationRequest(GOI_VIEW_PLAYERSHOP, (unsigned int) &SelectPlayer, 0);
                }
            }
        }
    } else {
...
int SaveBlackListPrivateSetting(KIniFile * pFile, LPCSTR
lpSection,
int nStart
);
...
BOOL KShortcutKeyCentre::SavePrivateSetting(KIniFile *pFile) {
    ...
    for (; i < ms_nCommands; i++) {
        sprintf(szKey, "%d", i);
        sprintf(szLine, "AddCommand(\"%s\", \"%s\", \"%s\")", GetKeyName(ms_pCommands[i].uKey),
                ms_pCommands[i].szCommand, ms_pCommands[i].szDo);
        pFile->WriteString(SCRIPT_SECTION, szKey, szLine);
    }
    SHORTFUNCMAP::iterator iFun = ms_FunsMap.begin();
    while (iFun != ms_FunsMap.end()) {
        sprintf(szKey, "%d", i);
        int nLen = sprintf(szLine, "RegisterFunctionAlias(\"%s\", \"%s\", %d", iFun->first.c_str(),
                           iFun->second.strName.c_str(),
    ...
    if (pWin) {
        ...
        while (1) {
            ...
            if (pTitle == NULL)
                break;
            sprintf(szKey, "%d", i);
            sprintf(szLine, "SetChannelTextColor(\"%s\", \"%s\", \"%s\")", pTitle,
                    std::string(GetColorString(uColor)).c_str(), std::string(GetColorString(uBColor)).c_str());
            pFile->WriteString(SCRIPT_SECTION, szKey, szLine);
            i++;
        }
        ...
        sprintf(szKey, "%d", i);
        sprintf(szLine, "SetMeTextColor(\"%s\", \"%s\")", std::string(GetColorString(uColor)).c_str(),
                std::string(GetColorString(uBColor)).c_str());
        pFile->WriteString(SCRIPT_SECTION, szKey, szLine);
        i++;
        ...
        sprintf(szKey, "%d", i);
        sprintf(szLine, "SetFriendTextColor(\"%s\", \"%s\")", std::string(GetColorString(uColor)).c_str(),
                std::string(GetColorString(uBColor)).c_str());
        pFile->WriteString(SCRIPT_SECTION, szKey, szLine);
        i++;
        ...
        sprintf(szKey, "%d", i);
        sprintf(szLine, "SetStrangerTextColor(\"%s\", \"%s\")", std::string(GetColorString(uColor)).c_str(),
                std::string(GetColorString(uBColor)).c_str());
        pFile->WriteString(SCRIPT_SECTION, szKey, szLine);
        i++;
    }
...
size_t Compile(const char *src, char *dst, size_t dstlen) {
    ...
    if (cntToken > 0) {//is func, fill ')'
        if (iFun != KShortcutKeyCentre::ms_FunsMap.end()) {
            int nParamCount = cntToken - 1;
            if (iFun->second.nParamNum - nParamCount > 0) {    //补默认参数
...
int KShortcutKeyCentre::AddCommand(
        COMMAND_SETTING *pAdd)    //复制Add数据并增加到Commands中，如果uKey!=0则覆盖原uKey，否则如szCommand[0]!=0则覆盖szCommand相同者
{
    int nIndex = -1;
    if (pAdd == NULL)
        return nIndex;
...
BOOL KShortcutKeyCentre::RegisterFunctionAlias(const char *strFunAlias, const char *strFun, int nParam,
