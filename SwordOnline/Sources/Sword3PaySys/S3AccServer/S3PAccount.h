...
public:
	...
	// static int Login(S3PDBConVBC* pConn, const char* strAccName, const char* strPassword, DWORD ClientID, int& nExtPoint, DWORD& nLeftTime);
	static int Login(S3PDBConVBC* pConn, const char* strAccName, const char* strPassword, DWORD ClientID, WORD& nExtPoint, DWORD& nLeftTime/*, DWORD MacNum*/);	// anti 3 acc by ve
